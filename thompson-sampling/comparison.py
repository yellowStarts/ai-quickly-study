...
N = [200, 1000, 5000] # 样本数组
D = 20 # 测试对象数量
convRanges = [(0., 0.1), (0., 0.3), (0., 0.5)] # 胜率范围数组
    ...
    for ranges in convRanges:
        ...
        for d in range(3, D + 1):
            ...
            for rounds in range(1000):
                ...
                for i in range(d):
                    conversionRates.append(np.random.uniform(low = ranges[0], high = ranges[1])) # 获取胜率
                ...
                for i in range(n):
                    ...
                    for j in range(d):
                        randomBeta = np.random.beta(nPosReward[j] +1, nNegRewoad[j] + 1)
                    ...
                    if X[i][selected] == 1:
                        ...
                        nNegRewoad[selected] += 1
                
                nSelected = nPosReward + nNegRewoad
